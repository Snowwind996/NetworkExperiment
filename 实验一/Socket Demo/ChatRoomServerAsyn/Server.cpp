...
int Server::ServerStartup(){
	...
	cout << "服务器端口:" << htons(Config::PORT) << endl;
	cout << "服务器ip地址为：" << this->srvAddr.sin_addr.S_un.S_addr << endl;
	cout << "服务器ip地址b为：" << this->srvAddr.sin_addr.S_un.S_un_b.s_b1 << this->srvAddr.sin_addr.S_un.S_un_b.s_b2 << this->srvAddr.sin_addr.S_un.S_un_b.s_b3<< this->srvAddr.sin_addr.S_un.S_un_b.s_b4<< endl;
	cout << "服务器ip地址w为：" << this->srvAddr.sin_addr.S_un.S_un_w.s_w1 << this->srvAddr.sin_addr.S_un.S_un_w.s_w2 << endl;
